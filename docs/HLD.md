...
> Space 只投影 Plan、Edits、Auto[LLM]、Full Access 四个 canonical profile，不再复制 Auto engine/timing/envPass 状态。Alpha.5 完成 Windows sandbox 并发准入、自愈与版本安全 daemon 升级；Space
