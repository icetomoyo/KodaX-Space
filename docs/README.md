...
> 见 [v0.1.39](features/v0.1.39.md)、[发布记录](releases/v0.1.39-release-readiness.md)、
...
| `features/v0.1.39.md`                                | 当前 release 设计 | KodaX 0.7.85、Actor convergence、journal epoch 与发布边界 |
| `releases/v0.1.39-release-readiness.md`              | 当前发布记录      | 门禁、GitHub CI、产物证据和人工项                      |
...
| `test-guides/ISSUE_178_v0.1.39_REGRESSION_GUIDE.md`  | 当前回归验收      | 覆盖 unknown Run、精确 Stop、journal epoch 和输入去重 |
