...
| 查看 v0.1.36 文档 Skill 规划        | [F137/F139 设计](features/v0.1.36.md)                                                                                                                                     |
...
| `releases/v0.1.34-release-readiness.md`              | 当前发布记录     | 记录门禁、GitHub CI、产物证据和未执行人工项    |
| `releases/v0.1.33-release-readiness.md`              | 历史发布记录     | 保留已发布版本的门禁、产物哈希和人工项         |
