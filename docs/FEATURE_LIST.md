...
| `v0.1.39`       | Actor settlement convergence and input/history preservation                                                           | Maintenance fixes                 | Development complete; release blocked on published KodaX `actorSettlementConvergence:1` bytes and packaged Windows fault injection. Unknown Runs accept after-turn input, preserve live history, and Stop only the visible exact Run.                                                     |
| `v0.1.40`       | —                                                                                                                     | none                              | —                                                                                                                                                                                                                                                                               |
| `v0.1.41`       | —                                                                                                                     | none                              | —                                                                                                                                                                                                                                                                               |
