...
| `v0.1.43`         | Crash-resumable complete Runtime exit                                                                                 | Maintenance / Recovery            | Exact npm Registry KodaX 0.7.91, SDK-owned exit settlement, recovery-before-owner-reconcile startup ordering, Windows same-boot exact-owner repair, and reboot-gated autonomous POSIX recovery without cached-PID signaling.                                                    |
