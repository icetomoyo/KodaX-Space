...
>
> 当前源码候选为 Space `0.1.46-alpha.7`，精确锁定 KodaX `0.7.96-beta.2`，并要求 `sandboxRuntime:11`、`runtimeAutoModeGuardrail:5`、`sharedSessionSettings:2`、`providerCredentialBroker:2` 与 `effectiveConfig:1`。
...
当前源码候选继续接入 KodaX 0.7.96-beta.2 的凭据安全
