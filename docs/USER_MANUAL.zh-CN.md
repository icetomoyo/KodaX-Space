...
>
> 当前源码候选为 Space `0.1.46-alpha.1`，精确锁定 KodaX `0.7.96-alpha.5`，并要求 `sandboxRuntime:9`、`runtimeAutoModeGuardrail:5`、`sharedSessionSettings:2`、`providerCredentialBroker:2` 与 `effectiveConfig:1`。
