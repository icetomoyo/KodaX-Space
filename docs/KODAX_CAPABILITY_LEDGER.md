...
> Space baseline: public `v0.1.30`; source `v0.1.31` development baseline
...
| -------------------------------- | --------------------------------------- | ------------------------------- | ----------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Runtime facade                   | KX-F253-F255, `@kodax-ai/kodax/runtime` | published `0.7.66+`             | supported/partial: F116 | Inline `RuntimeHostAdapter` now owns managed run start/cancel/dispose plus transcript/compact/fork/rewind and capability status. Space bridges remain for permissions, Workflow, MCP, Partner, artifacts, and External Agents; manual acceptance/release remain. |
...
| Host-registered semantic control tools | `registerTool`, KX-F247 execution context | published in `0.7.67` baseline | planned: F120           | Inline F116 runs can expose bounded Space inspect/apply tools with session/tool-call/profile attribution. Space owns the action registry, renderer broker, confirmation, undo, and receipts. Worker/daemon transport remains unavailable until host tools/callbacks are transport-safe. |
