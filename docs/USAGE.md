...
> **当前发布基线（2026-08-16）**：KodaX Space `v0.1.42` / npm Registry KodaX `0.7.89`。
...
> **当前源码基线**：root/Desktop/lockfile 精确锁定 npm Registry KodaX `0.7.92` 正式包及其 SRI，并要求
...
> 当前已发布版本为 KodaX Space [`v0.1.42`](https://github.com/icetomoyo/KodaX-Space/releases/tag/v0.1.42) / 精确 Registry KodaX `0.7.89`。
