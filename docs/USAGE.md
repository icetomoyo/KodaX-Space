...
> **当前发布基线（2026-08-14）**：KodaX Space `v0.1.40` / npm Registry KodaX `0.7.86`。
...
> 当前版本为 KodaX Space [`v0.1.40`](https://github.com/icetomoyo/KodaX-Space/releases/tag/v0.1.40) / 精确 Registry KodaX `0.7.86`。
