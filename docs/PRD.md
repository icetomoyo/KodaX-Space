...
> **2026-08-14 当前正式发布基线**：KodaX Space [`v0.1.40`](https://github.com/icetomoyo/KodaX-Space/releases/tag/v0.1.40) 对齐 npm 正式发布的精确 KodaX `0.7.86`，要求 sandboxRuntime v3、Actor settlement convergence 与 Session-scoped event journal；v0.1.39 保留为历史正式产品基线。
