  ...
  if (capability.status === 'available') {
    return {
      ...
      detail:
        ...
        'KodaX managed runs own silent scoped recall and governed outcome/review persistence over F228; Space v0.1.39 preserves compatibility diagnostics while the full F117 Episodes, Activity, correction, and purge UX remains planned.',
      since: '0.1.31',
    };
  }
  return {
...
export function registerVersionChannel(): void {
  registerChannel('space.version', async (): Promise<SpaceVersionOutput> => {
    ...
    return {
      ...
      capabilityContract: 'space-v0.1.39',
