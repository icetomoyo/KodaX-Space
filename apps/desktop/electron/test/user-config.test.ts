...
test('empty config → optional user fields undefined with explicit Auto LLM 0.7.76 defaults', async () => {
  mockUserConfig({});
...
test('Auto LLM defaults explicitly pin the KodaX 0.7.76 timeout', async () => {
  mockUserConfig({});
