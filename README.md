...
<p align="center">
  ...
  <img alt="KodaX SDK" src="https://img.shields.io/badge/KodaX_SDK-0.7.83-f0a020?style=flat-square">
...
| KodaX baseline       | Root/Desktop manifests and lock views use exact Registry KodaX 0.7.83 bytes and the release gate rejects drift or local tarballs.                                              |
...
| [docs/USER_MANUAL.zh-CN.md](docs/USER_MANUAL.zh-CN.md)                                                   | Illustrated Chinese manual for the v0.1.37 release baseline.                             |
