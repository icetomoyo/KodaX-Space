...
| Area                 | Summary                                                                                                                                              |
| -------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------- |
| Runtime contract     | KodaX 0.7.87 exact Registry bytes; existing Runtime capability negotiation remains explicit and is never inferred from SemVer.                       |
| Provider recovery    | Replacement recoveries clear only provisional assistant/thinking drafts; completed tools, diagnostics, manual continuation, and repeated text remain. |
| Latest SDK gate      | npm `latest` was checked at release preparation time and is pinned to exact 0.7.87 with the lockfile SRI.                                             |
| Documentation        | README files, manuals, capability ledger, release design/readiness, regression guide, changelog, and `kodax_manual` share the v0.1.41 boundary.     |

See [CHANGELOG.md](CHANGELOG.md), the [v0.1.41 design](docs/features/v0.1.41.md), and the [v0.1.41 release record](docs/releases/v0.1.41-release-readiness.md).
...
| KodaX baseline | Historical v0.1.37 used KodaX 0.7.83; the published v0.1.41 release now uses exact Registry KodaX 0.7.87 bytes documented above.                         |
...
| [docs/USER_MANUAL.zh-CN.md](docs/USER_MANUAL.zh-CN.md)                                                   | Illustrated Chinese manual for the v0.1.41 release baseline.                             |
...
| [docs/features/v0.1.41.md](docs/features/v0.1.41.md)                                                     | v0.1.41 provider recovery, latest KodaX 0.7.87, and release boundary.                    |
| [docs/releases/v0.1.41-release-readiness.md](docs/releases/v0.1.41-release-readiness.md)                 | v0.1.41 gates, exact KodaX 0.7.87 contract, and release evidence.                       |
| [docs/test-guides/ISSUE_181_v0.1.41_REGRESSION_GUIDE.md](docs/test-guides/ISSUE_181_v0.1.41_REGRESSION_GUIDE.md) | v0.1.41 provider recovery and Ctrl+R regression coverage.                    |
...
| `v0.1.41`                    | Latest KodaX 0.7.87, provider recovery projection, Ctrl+R transcript parity, GLM-5.3 defaults, and complete release documentation alignment.                              |
