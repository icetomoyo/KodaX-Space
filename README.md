...
| Latest SDK gate      | npm `latest` was checked at release preparation time and is pinned to exact 0.7.88 with the lockfile SRI.                                             |
...
| KodaX baseline | Historical v0.1.37 used KodaX 0.7.83; the published v0.1.42 release now uses exact Registry KodaX 0.7.88 bytes documented above.                         |
...
| [docs/features/v0.1.42.md](docs/features/v0.1.42.md)                                                     | v0.1.42 causal transcript, KodaX 0.7.88, and release boundary.                         |
...
| `v0.1.42`                    | Latest KodaX 0.7.88, Actor settlement convergence v2, causal transcript ownership, Session deletion feedback, permission reason visibility, and complete release documentation alignment. |
