...
| KodaX baseline | The published v0.1.39 release uses exact Registry KodaX 0.7.85 bytes; current `main` has moved to the exact 0.7.86 source baseline documented above. |
